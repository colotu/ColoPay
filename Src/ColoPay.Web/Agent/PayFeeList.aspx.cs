...
{
    public partial class PayFeeList : PageBaseAgent
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                lbAgentIDPid.Text = AgentBll.GetAgentID(currentUser.UserName).ToString();
                ShowInfo(lbAgentIDPid.Text);
            }
        }
        ...
        protected void gridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                PayFreeBll.Delete(int.Parse(lbAgentIDPid.Text), int.Parse(ID));
