<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Left.aspx.cs" Inherits="ColoPay.Web.Enterprise.left" %>
...
<div class=" page-sidebar navbar-collapse collapse content_wrap" >
 ...
 <div class="nav-left">
    ...
    <script src="/admin/js/left_metronic.js" type="text/javascript"></script>
     <script src="/admin/js/left_layout.js" type="text/javascript"></script>
