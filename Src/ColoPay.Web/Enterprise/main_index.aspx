<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main_index.aspx.cs" Inherits="ColoPay.Web.Enterprise.main_index" %>

<!DOCTYPE html>
<html>
<head id="Head1" runat="server">
    <title>银河支付商家后台</title>
                ...
                <div title="我的桌面">
                    <div id="tabIndex" style="overflow: scroll; overflow-x: hidden; overflow-y: hidden">
                        <div class="admintitle adminxia" style="margin-top: 10px">
                            ...
                            <strong>
                                <asp:Literal ID="Literal1" runat="server" Text="商户信息" /></strong>
                            <asp:Label ID="lbEnterPid" runat="server" Text="" Visible="false"></asp:Label>&nbsp;&nbsp;<asp:Label ID="lblMsg" runat="server" ForeColor="Red"></asp:Label>
                        </div>
                        ...
                        <div class="admintitle adminxia" style="margin-top: 10px">
                            ...
                            <strong>
                                <asp:Literal ID="Literal11" runat="server" Text="接口信息" /></strong>
                        </div>
                        <div class="main_bottomzi">
                            <table style="width: 80%;" cellpadding="2" cellspacing="1" class="border">
                                <tr>
