...
using System.Linq;
using System.Web;
using ColoPay.Web.SMSService;

namespace ColoPay.Web.Components
{
    public class SMSHelper
    {
        ...
        public static bool AddSendNum(string requestIP, string phoneNumber)
        {
            ...
            if (!String.IsNullOrWhiteSpace(verifiedManner)  &&  verifiedManner.ToLower() == "file")
            {
                ...
                int ModelCache = YSWL.Common.Globals.SafeInt(BLL.SysManage.ConfigSystem.GetValueByCache("ModelCache"), 30);
                //手机号
                string PhoneCacheKey = "YSWL.GetMsgCode_Phone" + phoneNumber;
