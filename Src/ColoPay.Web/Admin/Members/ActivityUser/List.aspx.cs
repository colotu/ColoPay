...
namespace ColoPay.Web.Admin.Members.ActivityUser
{
    public partial class List : PageBaseAdmin
    {
        //int Act_ShowInvalid = -1; //查看失效数据行为
        //private ColoPay.BLL.SNS.GradeConfig bll = new ColoPay.BLL.SNS.GradeConfig();
        ColoPay.BLL.Members.Users user = new BLL.Members.Users();
        ...
        public void BindData()
        {
            ...
            {
                strWhere.Append(" NickName like '%"+YSWL.Common.InjectionFilter.SqlFilter(txtKeyword.Text)+"%' ");
            }
            if (YSWL.Common.Globals.SafeInt(dropActive.SelectedValue, -1) > -1)
            {
            ...
            if (YSWL.Common.Globals.SafeInt(dropUnActive.SelectedValue, -1) > -1)
            {
                if (strWhere.Length > 0)
                {
                    strWhere.Append(" and ");
            ...
            //}
            //if (YSWL.Common.Globals.SafeInt(dropType.SelectedValue,-1)>-1)
            //{
            //    if (strWhere.Length > 0)
            //    {
            //        strWhere.Append(" and ");
