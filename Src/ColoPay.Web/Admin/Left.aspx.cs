...
#pragma warning disable CS0649 // 从未对字段“Left.TreeListofLang”赋值，字段将一直保持其默认值 null
        Hashtable TreeListofLang;
#pragma warning restore CS0649 // 从未对字段“Left.TreeListofLang”赋值，字段将一直保持其默认值 null
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if ((Request.Params["id"] != null) && (Request.Params["id"].ToString() != ""))
                {
                    ...
                    ColoPay.Model.SysManage.SysNode model = sm.GetModelByCache(Convert.ToInt32(id));
