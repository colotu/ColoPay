...
namespace ColoPay.Web.Admin.SysManage
{
    ...
    {
        ColoPay.BLL.SysManage.SysTree bll = new ColoPay.BLL.SysManage.SysTree();
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                strSql.AppendFormat(" {0} TreeText like '%{1}%'", connector, YSWL.Common.InjectionFilter.SqlFilter(txtKeyword.Text.Trim()));
            }
            if (strSql.Length > 0)
            {
        ...
        protected void gridView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Enabled")
            {
                ...
                {
                    int nodeid = YSWL.Common.Globals.SafeInt(e.CommandArgument.ToString(), 0);
        ...
        protected void listTarget2_Changed(object sender, EventArgs e)
        {
            ...
            {
                ParentID = YSWL.Common.Globals.SafeInt(listTarget2.SelectedValue,0);
