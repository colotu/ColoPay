...
namespace ColoPay.Web.Admin.SysManage
{
    public partial class UserLog : PageBaseAdmin
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            ColoPay.BLL.SysManage.UserLog.Delete(idlist);
        ...
        {
            ColoPay.BLL.SysManage.UserLog.Delete(Convert.ToDateTime(txtDate.Text));
        ...
        public void BindData()
        {
            ...
            {
                strWhere = " OPInfo like '%" + YSWL.Common.InjectionFilter.SqlFilter(txtKeyword.Text.Trim()) + "%'";
            }
            ds = ColoPay.BLL.SysManage.UserLog.GetList(strWhere);
        ...
        protected void gridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            ColoPay.BLL.SysManage.UserLog.Delete(ID);
            gridView.OnBind();
        }
