...
namespace ColoPay.Web.Admin.SysManage
{
    ...
    {
        ColoPay.BLL.SysManage.ErrorLog bll = new ColoPay.BLL.SysManage.ErrorLog();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            ColoPay.BLL.SysManage.ErrorLog.Delete(idlist);
        ...
        public void BindData()
        {
            ...
            ds = ColoPay.BLL.SysManage.ErrorLog.GetList(-1, string.Format("Loginfo like '%{0}%'",InjectionFilter.SqlFilter(keyword)), "id desc");
        ...
        protected void gridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            ColoPay.BLL.SysManage.ErrorLog.Delete(ID);
            gridView.OnBind();
            MessageBox.ShowSuccessTip(this, Resources.Site.TooltipDelOK);
        }
