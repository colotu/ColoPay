...
namespace ColoPay.Web.SysManage
{
	/// <summary>
	/// search 的摘要说明。
	/// </summary>
...
//		}
		...
		protected void btnSearch_Click(object sender, System.EventArgs e)
		{
			...
			if(name!="")
			{				
				strsql+=" and (TreeText like '%"+YSWL.Common.InjectionFilter.SqlFilter(name)+"%')";
			}	
			...
			if(comment!="")
			{
				strsql+=" and (comment like '%"+YSWL.Common.InjectionFilter.SqlFilter(comment)+"%')";
			}
