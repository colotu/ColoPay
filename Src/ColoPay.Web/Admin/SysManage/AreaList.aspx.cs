...
namespace ColoPay.Web.Admin.SysManage
{
    public partial class AreaList : PageBaseAdmin
    {
        ...
        ColoPay.BLL.SysManage.ConfigArea areaBll = new ColoPay.BLL.SysManage.ConfigArea();
        ...
        {
            ColoPay.Model.SysManage.ConfigArea areaModel = new ColoPay.Model.SysManage.ConfigArea();
        ...
        protected void gridView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Status")
            {
                ...
                {
                    ColoPay.Model.SysManage.ConfigArea areaModel = new Model.SysManage.ConfigArea();
