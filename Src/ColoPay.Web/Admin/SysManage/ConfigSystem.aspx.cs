    ...
    public partial class ConfigSystem : PageBaseAdmin
    {
        ...
        public void BindData()
        {
            ...
            if (txtKeyWord.Text.Trim() != "")
            {
                ...
                strWhere += string.Format(" KeyName like '%{0}%' ", YSWL.Common.InjectionFilter.SqlFilter(this.txtKeyWord.Text.Trim()));
            }
            ds = ColoPay.BLL.SysManage.ConfigSystem.GetList(strWhere);
        ...
        protected void gridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            ColoPay.BLL.SysManage.ConfigSystem.Delete(ID); 
        ...
        public void gridView_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            ColoPay.BLL.SysManage.ConfigSystem.Update(int.Parse(id), keyname, Value, Description);
            gridView.EditIndex = -1;
            gridView.OnBind();
