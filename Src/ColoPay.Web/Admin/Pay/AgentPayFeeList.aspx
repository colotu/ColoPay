<%@ Page Title="<%$ Resources:SysManage, ptMenuManage%>" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="AgentPayFeeList.aspx.cs" Inherits="ColoPay.Web.Admin.Pay.AgentPayFeeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="newslistabout">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang padd-no">
            <tr>
                <td height="35" bgcolor="#FFFFFF" class="newstitlebody">
                    <asp:Literal ID="Literal1" runat="server" Text="代理商名称" />：
        ...
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="ModeId" HeaderText="支付通道ID"
                    SortExpression="ModeId" ControlStyle-Width="50px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" />

                <asp:BoundField DataField="Name" HeaderText="支付通道名称"
                    SortExpression="Name" ControlStyle-Width="400px" ItemStyle-Width="300px" ItemStyle-HorizontalAlign="Center" />

                <asp:BoundField DataField="Charge" HeaderText="费率" ItemStyle-HorizontalAlign="Left" />

                <asp:BoundField DataField="Charge" HeaderText="编辑" ItemStyle-HorizontalAlign="Left" />
