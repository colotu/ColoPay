        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang padd-no">
            <tr>
                <td height="35" bgcolor="#FFFFFF" class="newstitlebody">
                    ...
                    -
                    <asp:TextBox ID="txtDateEnd" Width="120px" runat="server"></asp:TextBox>
        ...
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="OrderCode" HeaderText="平台订单编码"
                    SortExpression="OrderCode" ControlStyle-Width="80px" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Left" />
                ...
                <asp:TemplateField HeaderText="状态" ItemStyle-HorizontalAlign="center" ItemStyle-Width="160">
                    <ItemTemplate>
                        <%# GetPayStatus(Eval("PaymentStatus"),Eval("OrderStatus")) %>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField ControlStyle-Width="100" HeaderText="订单操作" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate> 
                        <span class="operate">
                            <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Pay"
                                Style="display:none;border: 1px transparent solid; padding-left: 5px; padding-right: 5px; margin-right: 5px; padding-top: 2px; padding-bottom: 2px;"
                                CommandArgument='<%# Eval("OrderCode")%>'
                                OnClientClick='return confirm($(this).attr("ConfirmText"))' ConfirmText="您确定要将订单设置为已支付吗？请在支付网站方确认用户已支付."
                                Text="确认支付" class="PayAction" payStatus='<%# Eval("PaymentStatus")%>'></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Notify"
                                Style="display:none;border: 1px transparent solid; padding-left: 5px; padding-right: 5px; margin-right: 5px; padding-top: 2px; padding-bottom: 2px;"
                                CommandArgument='<%# Eval("OrderCode")%>' 
                                Text="异步通知" class="PayNotify" payStatus='<%# Eval("PaymentStatus")%>'  orderStatus='<%# Eval("OrderStatus")%>'  ></asp:LinkButton>
                        </span>
                    </ItemTemplate>
                     </asp:TemplateField>
            </Columns>
