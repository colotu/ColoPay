<%@ Page Title="<%$ Resources:Site, ptAddUser %>" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="AgentPayFeeEdit.aspx.cs" Inherits="ColoPay.Web.Admin.Pay.AgentPayFeeEdit" %>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
            <tr>
                <td bgcolor="#FFFFFF" class="newstitle">
                    <asp:Literal ID="Literal1" runat="server" Text="设置费率信息" />
                </td>
            </tr>
            <tr>
                <td bgcolor="#FFFFFF" class="newstitlebody">
                    <asp:Literal ID="Literal6" runat="server" Text="代理商名称：" /><asp:Literal ID="lbEnterName" runat="server" Text="" />
