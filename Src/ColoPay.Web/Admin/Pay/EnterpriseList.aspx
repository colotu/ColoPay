<%@ Page Title="<%$ Resources:SysManage, ptMenuManage%>" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="EnterpriseList.aspx.cs" Inherits="ColoPay.Web.Admin.Pay.EnterpriseList" %>
            ...
            <div class="newsicon">
                <ul>
                    <li class="add-btn" id="liAdd" runat="server"><a href="EnterpriseAdd.aspx">
                        <asp:Literal ID="Literal5" runat="server" Text="增加商户" /></a>
                    </li>
                </ul>
            </div>
        </div>
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="设置费率" ControlStyle-Width="80"
                    ...
                    Text="设置费率" ItemStyle-HorizontalAlign="Center" />
                ...
                <asp:TemplateField ControlStyle-Width="50px" HeaderText="删除"
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete"
                            OnClientClick='return confirm($(this).attr("ConfirmText"))' ConfirmText="删除商家"
