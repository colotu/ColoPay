...
namespace ColoPay.Web.Handlers.Tools
{
    ...
    public class QRHandler : IHttpHandler
    {
        ...
        private static void GenQRCode(HttpContext context)
        {
            ...
            int size = YSWL.Common.Globals.SafeInt(context.Request.QueryString["size"], 100);

            ErrorCorrectionLevel errorCorrectionLevel;
            ImageFormat imgFormat;
            BarcodeFormat barcodeFormat = YSWL.Common.Globals.SafeEnum(context.Request.QueryString["mod"],
