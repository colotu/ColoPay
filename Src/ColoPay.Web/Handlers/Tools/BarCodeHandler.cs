...
namespace ColoPay.Web.Handlers.Tools
{
    ...
    public class BarCodeHandler : IHttpHandler
    {
        ...
        private static void GenQRCode(HttpContext context)
        {
            ...
            content = YSWL.Common.Globals.UrlDecode(content);
            ...
            int margin = YSWL.Common.Globals.SafeInt(context.Request.QueryString["margin"], 4);
            int width = YSWL.Common.Globals.SafeInt(context.Request.QueryString["width"], 50);
            int height = YSWL.Common.Globals.SafeInt(context.Request.QueryString["height"], 20);

            ErrorCorrectionLevel errorCorrectionLevel;
            ImageFormat imgFormat;
            BarcodeFormat barcodeFormat = CodeFormat(barType); //YSWL.Common.Globals.SafeEnum(context.Request.QueryString["mod"],
        ...
        private static void DeQRCode(HttpContext context)
        {
            ...
            dataUrl = YSWL.Common.Globals.UrlDecode(dataUrl);
