...
namespace ColoPay.Web.Areas
{
    public abstract class AreaRegistrationBase : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.Namespaces.Add(string.Format("ColoPay.Web.Areas.{0}.Controllers", AreaName));
            ...
            if (MvcApplication.MainAreaRoute != CurrentArea || IsRegisterArea)
            {
                context.MapRoute(
                    ...
                    , namespaces: new[] { string.Format("ColoPay.Web.Areas.{0}.Controllers", AreaName) }
                    );
