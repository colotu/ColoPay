...
{
    public class AccountController : MSNSControllerBase
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            if (IsNeedBind)
            {
                ...
                return String.IsNullOrWhiteSpace(returnUrl) ? Redirect(ViewBag.BasePath + "Profile/Index") : Redirect(returnUrl);
            }
            #endregion
