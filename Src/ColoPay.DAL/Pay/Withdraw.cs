...
namespace ColoPay.DAL.Pay
{
	...
	public partial class Withdraw
	{
        ...
        public int Add(ColoPay.Model.Pay.Withdraw model)
        {
            ...
            strSql.Append("WithdrawCode,EnterpriseID,Amount,WithdrawBank,WithdrawInfo,WithdrawNum,Status,CreatedDate,CreatedUserId,AuditDate,AuditUserId,PayDate,PayUserId,Remark)");
            ...
            parameters[3].Value = model.WithdrawBank;
            parameters[4].Value = model.WithdrawInfo;
            parameters[5].Value = model.WithdrawNum;
            ...
            parameters[12].Value = model.PayUserId;
        ...
        public bool Update(ColoPay.Model.Pay.Withdraw model)
        {
            ...
            parameters[12].Value = model.PayUserId;
            parameters[13].Value = model.Remark;
            parameters[14].Value = model.WithdrawId;
        ...
        public ColoPay.Model.Pay.Withdraw GetModel(int WithdrawId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 WithdrawId,WithdrawCode,EnterpriseID,Amount,WithdrawBank,WithdrawInfo,WithdrawNum,Status,CreatedDate,CreatedUserId,AuditDate,AuditUserId,PayDate,PayUserId,Remark from Pay_Withdraw ");
            strSql.Append(" where WithdrawId=@WithdrawId");
            SqlParameter[] parameters = {
                    new SqlParameter("@WithdrawId", SqlDbType.Int,4)
            };
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select WithdrawId,WithdrawCode,EnterpriseID,Amount,WithdrawBank,WithdrawInfo,WithdrawNum,Status,CreatedDate,CreatedUserId,AuditDate,AuditUserId,PayDate,PayUserId,Remark ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" WithdrawId,WithdrawCode,EnterpriseID,Amount,WithdrawBank,WithdrawInfo,WithdrawNum,Status,CreatedDate,CreatedUserId,AuditDate,AuditUserId,PayDate,PayUserId,Remark ");
            strSql.Append(" FROM Pay_Withdraw ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public bool Pay(ColoPay.Model.Pay.Withdraw withdrawModel, ColoPay.Model.Pay.BalanceDetail detailModel,int userId)
        {
            ...
            parameters1[0].Value = detailModel.EnterpriseID; 
            parameters1[1].Value = withdrawModel.Amount;
