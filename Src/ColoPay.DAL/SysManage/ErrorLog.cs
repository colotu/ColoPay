...
namespace ColoPay.DAL.SysManage
{
    public class ErrorLog 
    {
        ...
        /// Add a record
        /// </summary>
        public int Add(ColoPay.Model.SysManage.ErrorLog model)
        {
        ...
        /// Update a record
        /// </summary>
        public void Update(ColoPay.Model.SysManage.ErrorLog model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// </summary>
        public ColoPay.Model.SysManage.ErrorLog GetModel(int ID)
        {
