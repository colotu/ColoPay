...
namespace ColoPay.DAL.SysManage
{
	/// <summary>
	/// 数据访问类:Area
	/// </summary>
    public partial class ConfigArea
	{
		...
		public ColoPay.Model.SysManage.ConfigArea GetModel(string AreaName)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 AreaName,Status from SA_Config_Area ");
			strSql.Append(" where AreaName=@AreaName ");
			SqlParameter[] parameters = {
					new SqlParameter("@AreaName", SqlDbType.NVarChar,50)			};
			parameters[0].Value = AreaName;

			ColoPay.Model.SysManage.ConfigArea model=new ColoPay.Model.SysManage.ConfigArea();
		...
		/// 得到一个对象实体
		/// </summary>
		public ColoPay.Model.SysManage.ConfigArea DataRowToModel(DataRow row)
		{
			ColoPay.Model.SysManage.ConfigArea model=new ColoPay.Model.SysManage.ConfigArea();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SA_Config_Area T ");
