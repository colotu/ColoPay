...
namespace ColoPay.BLL.SysManage
{
    ...
    public class ErrorLog
    {
        ...
        /// Add a record
        /// </summary>
        public static int Add(ColoPay.Model.SysManage.ErrorLog model)
        {
        ...
        /// Update a record
        /// </summary>
        public static void Update(ColoPay.Model.SysManage.ErrorLog model)
        {
            dal.Update(model);
        }
        ...
        /// </summary>
        public static ColoPay.Model.SysManage.ErrorLog GetModel(int ID)
        {
        ...
        /// </summary>
        public static ColoPay.Model.SysManage.ErrorLog GetModelByCache(int ID)
        {
            ...
            return (ColoPay.Model.SysManage.ErrorLog)objModel;
        }
        ...
        /// Query data list
        /// </summary>
        public static List<ColoPay.Model.SysManage.ErrorLog> GetModelList(string strWhere)
        {
        ...
        /// Query data list
        /// </summary>
        public static List<ColoPay.Model.SysManage.ErrorLog> DataTableToList(DataTable dt)
        {
            List<ColoPay.Model.SysManage.ErrorLog> modelList = new List<ColoPay.Model.SysManage.ErrorLog>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                ColoPay.Model.SysManage.ErrorLog model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new ColoPay.Model.SysManage.ErrorLog();
