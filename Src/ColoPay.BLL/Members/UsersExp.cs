...
namespace ColoPay.BLL.Members
{
    ...
    public class UsersExp : ColoPay.Model.Members.UsersExpModel
    {
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(ColoPay.Model.Members.UsersExpModel model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(ColoPay.Model.Members.UsersExpModel model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public ColoPay.Model.Members.UsersExpModel GetUsersExpModel(int UserID)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public ColoPay.Model.Members.UsersExpModel GetModelByCache(int UserID)
        {
            ...
            return (ColoPay.Model.Members.UsersExpModel)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<ColoPay.Model.Members.UsersExpModel> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<ColoPay.Model.Members.UsersExpModel> DataTableToList(DataTable dt)
        {
            List<ColoPay.Model.Members.UsersExpModel> modelList = new List<ColoPay.Model.Members.UsersExpModel>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                ColoPay.Model.Members.UsersExpModel model;
        ...
        /// 获取用户全部属性信息实体，从缓存中
        /// </summary>
        public ColoPay.Model.Members.UsersExpModel GetUsersExpModelByCache(int UserID)
        {
            string CacheKey = "UsersExpModel-" + UserID;
            object objModel = YSWL.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
        ...
        public List<ColoPay.Model.Members.UsersExpModel> GetUserListByKeyWord(string NickName, string orderby, int startIndex, int endIndex)
        {
      ...
      /// <returns></returns>
        ...
        /// <param name="SaleId"></param>
        /// <returns></returns>
        public ColoPay.Model.Members.UsersExpModel GetSalesModel(int SaleId)
        {
