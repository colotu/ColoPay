...
namespace YSWL.Accounts.Data
{
    ...
    public class User : IUser
    {
        ...
        public int Create(string userName, byte[] password, string nickName, string trueName, string sex, string phone, string email, int employeeID, string departmentID, bool activity, string userType, int style, int User_iCreator, DateTime User_dateValid, string User_cLang, DateTime User_dateApprove, int User_iApproveState = 0)
        {
            ...
            try
            {
                //DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_CreateUser", parameters, out rowsAffected);
        ...
        public DataRow Retrieve(int userID)
        {
            ...
            using (DataSet users = DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_GetUserDetails", parameters, "Users"))
            {
        ...
        public DataRow Retrieve(string userName)
        {
            ...
            using (DataSet users = DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_GetUserDetailsByUserName", parameters, "Users"))
            {
                if (users.Tables[0].Rows.Count == 0)
                {
            ...
            )
        {
            ...
            DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_UpdateUser", parameters, out rowsAffected);
        ...
        public bool SetPassword(string UserName, byte[] encPassword)
        {
            ...
            DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_SetPassword", parameters, out rowsAffected);
            return (rowsAffected == 1);
        }
        #endregion
        ...
        public bool Delete(int userID)
        {
            ...
            DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_DeleteUser", parameters, out rowsAffected);
            return (rowsAffected == 1);
        }
        #endregion
        ...
        public int ValidateLogin(string userName, byte[] encPassword)
        {
            ...
            return DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_ValidateLogin", parameters, out rowsAffected);
        }
        ...
        public int TestPassword(int userID, byte[] encPassword)
        {
            ...
            return DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_TestPassword", parameters, out rowsAffected);
        }
        ...
        public DataSet GetUserList(string key)
        {
            ...
            return DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_GetUsers", parameters, "Users");
        }
        /// <summary>
        /// 根据用户类型和关键字查询用户信息
        /// </summary>
        ...
        public DataSet GetUsersByDepart(string DepartmentID, string Key)
        {
            ...
            parameters[1].Value = Key;
            return DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_GetUsersByDepart", parameters, "Users");
        }
        ...
        public ArrayList GetUserRoles(int userID)
        {
            ...
            SqlDataReader tmpReader = DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_GetUserRoles", parameters);
        ...
        public DataSet GetEffectivePermissionLists(int userID)
        {
            SqlParameter[] parameters = { new SqlParameter("@UserID", SqlDbType.Int, 4) };
            parameters[0].Value = userID;
            DataSet ds = DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_GetEffectivePermissionList", parameters, "PermissionList");
            return ds;
        }
        /// <summary>
        /// 获取用户有效的权限名称列表
        ...
        public ArrayList GetEffectivePermissionList(int userID)
        {
            ...
            SqlDataReader tmpReader = DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_GetEffectivePermissionList", parameters);
            while (tmpReader.Read())
            {
        ...
        public ArrayList GetEffectivePermissionListID(int userID)
        {
            ...
            SqlDataReader tmpReader = DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_GetEffectivePermissionListID", parameters);
            while (tmpReader.Read())
            {
        ...
        public bool AddRole(int userId, int roleId)
        {
            ...
            DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_AddUserToRole", parameters, out rowsAffected);
            return (rowsAffected == 1);
        }
        ...
        public bool RemoveRole(int userId, int roleId)
        {
            ...
            DBHelper.DefaultDBHelper.RunProcedure("sp_Accounts_RemoveUserFromRole", parameters, out rowsAffected);
            return (rowsAffected == 1);
        }
        #endregion
